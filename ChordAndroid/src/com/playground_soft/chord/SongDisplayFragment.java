...
public class SongDisplayFragment extends Fragment {
	...
	private static final File DIR_ROOT = Environment.getExternalStorageDirectory();
	...
	private void updateOutput() {
		ImageView view = (ImageView) this.getActivity().findViewById(R.id.imageView1);
		 mOutputDrawable = SongFactory.create(mDocument, this.getActivity(), mTransposeValue, mIsTransposeInSharp);
